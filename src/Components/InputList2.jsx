...
class InputList2 extends Component{
    ...
    handleChange=(e)=>{
     ...
     submitForm=()=>{  
        ...
        let display = [{ ...this.auctionValue()}, { ...this.bonusFirstIntallment() }, { ...this.bonusSecondInstallment() }, ...this.bonusThirdInstallment()];
